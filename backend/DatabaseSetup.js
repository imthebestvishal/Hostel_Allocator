...
function setupDatabase() {
  ...
  const sheetsConfig = [
    {
      name: 'Students',
      headers: ['ApplicationID', 'EnrollmentNo', 'Name', 'Gender', 'DOB', 'Email', 'Phone', 'Aadhaar', 'Programme', 'Branch', 'Year', 'TwelfthMarks', 'Category', 'State', 'ParentsTransferred', 'DistanceKm', 'PWD', 'HostelPref', 'RoommatePreference', 'Status', 'Priority', 'Timestamp', 'Hobbies', 'AadhaarFile', 'PhotoFile', 'MarksheetFile', 'PwdCertificateFile', 'AadhaarStatus', 'PhotoStatus', 'MarksheetStatus', 'PwdCertificateStatus', 'AadhaarRemarks', 'PhotoRemarks', 'MarksheetRemarks', 'PwdCertificateRemarks', 'DocumentStatus', 'DocumentRemarks', 'DiscrepancyEmailSentAt', 'DocumentPolicyVersion', 'MarksheetFileId', 'MarksheetMimeType', 'MarksheetFileSize', 'MarksheetChecksum', 'MarksheetBrowserChecksum', 'MarksheetScreeningAttempts', 'MarksheetVerificationCheckedAt', 'MarksheetVerificationProvider', 'MarksheetVerificationModel', 'MarksheetVerificationConfidence', 'MarksheetVerificationReasons', 'MarksheetVerificationExplanationCodes', 'MarksheetVerificationSummary', 'MarksheetExtractedData', 'MarksheetVerificationLastError', 'OfflineVerificationEmailSentAt', 'MarksheetRetrievedChecksum', 'MarksheetMetadataSummary', 'MarksheetMetadataFindings', 'MarksheetAiProvenanceStatus', 'MarksheetAiProvider', 'MarksheetC2paStatus', 'MarksheetC2paProvider', 'MarksheetC2paIssuer', 'MarksheetC2paSigner', 'MarksheetC2paSigningTime', 'MarksheetC2paVerifierVersion', 'MarksheetApprovalSource', 'MarksheetDigitalSignatureStatus', 'MarksheetSynthIdStatus', 'MarksheetSynthIdProvider', 'MarksheetSynthIdDetectorVersion', 'DocumentManualReviewer', 'DocumentManualReviewedAt', 'DocumentManualEvidenceSource', 'DocumentPreviousStatus', 'DocumentAuditLog']
    },
    {
      name: 'Rooms',
